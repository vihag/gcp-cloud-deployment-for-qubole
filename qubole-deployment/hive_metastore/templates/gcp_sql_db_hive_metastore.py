...
def GenerateConfig(context):
    ...
    resources = [
        {
            'name': 'hive-metastore-inst-'+context.properties['deployment-suffix'],
            ...
            'properties': {
                ...
                'settings': {
                    'tier': context.properties['db_tier'],
                    'ipConfiguration': {
                        'authorizedNetworks': [
                        ]
                    },
        ...
        },
        {
            ...
            'properties': {
                ...
                'name': 'hive',
                'instance': '$(ref.hive-metastore-inst-'+context.properties['deployment-suffix']+'.name)'
            },
            'metadata': {
                'dependsOn': ['hive-metastore-inst-'+context.properties['deployment-suffix'], 'cloud-sql-instance-root-user']
            }
        },
        {
            ...
            'properties': {
                ...
                'host': '%',
                'instance': '$(ref.hive-metastore-inst-'+context.properties['deployment-suffix']+'.name)',
                'password': context.properties['db_root_password']
            },
            'metadata': {
                'dependsOn': ['hive-metastore-inst-'+context.properties['deployment-suffix']]
            }
        },
        {
            ...
            'metadata': {
                'dependsOn': ['hive-metastore-inst-'+context.properties['deployment-suffix'], 'hive_metastore_db']
            }
        },
        {
            ...
            'metadata': {
                'dependsOn': ['hive-metastore-inst-'+context.properties['deployment-suffix'], 'hive_metastore_db', 'hive-metastore-user']
            }
        }
    ]
