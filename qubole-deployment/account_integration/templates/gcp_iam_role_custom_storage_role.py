...
def GenerateConfig(context):
    ...
    resources = [{
        ...
        'properties': {
            ...
            'roleId': 'qubole_custom_storage_role_'+context.properties['deployment-suffix'],
            'role': {
                'title': 'qubole_custom_storage_role_'+context.properties['deployment-suffix'],
                'description': 'Custom Role to provide Qubole permissions to R/W to GCS buckets',
                'stage': 'BETA',
                'includedPermissions': [
                                        'storage.buckets.get',
